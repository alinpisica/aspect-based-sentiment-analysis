...
BART_FINE_TUNED_OUTPUT = '../../../results/ATE/MAMS/models/bart_fine_tuned_512.pth'

MODEL_OUTPUT = '../../../results/ATE/MAMS/models/bart_pre_trained_dropout_linear_512.pth'
STATS_OUTPUT = '../../../results/ATE/MAMS/stats/bart_pre_trained_dropout_linear_512.csv'
...
for i in range(NO_RUNS):
    ...
    plt.savefig(f'../../../results/ATE/MAMS/plots/bart_pt_do_linear/train_loss_run_{i + 1}.png')
